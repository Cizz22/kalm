...
@section('content')
    <div class="container py-2">
        <div class="player">
            <a href="{{ route('meditasi.home') }}"><button type="button" class="btn-close"
            ...
            <div class="btn-box">
                ...
                <a href={{ route('meditasi.favourite', ['id' => $lagumeditasi->id]) }}><i
                        class="material-icons favorite {{ $fav ? 'active' : null }}">favorite</i></a>
