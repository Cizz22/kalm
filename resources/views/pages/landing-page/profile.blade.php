                    ...
                    <div class="row">
                        <div class="col">
                            <div class="d-flex flex-row gap-3">
                                ...
                                <p><i class="fa-solid fa-heart" style="color: #FF84A2;"></i>
                                    {{ Auth::user()->laguFavorit->count() }} Favourites</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col mt-2">
                        ...
                        <div class="col">
                            <ul class="nav nav-tabs justify-content-start flex-row m-0 p-0" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="ambient-tab" data-bs-toggle="tab"
                                        data-bs-target="#ambient-tab-pane" type="button" role="tab">Ambient Sounds</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="profile-tab" data-bs-toggle="tab"
                                        data-bs-target="#psychologists-tab-pane" type="button" role="tab"
                                        aria-controls="psychologists-tab-pane" aria-selected="false">Psychologists</button>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="container-fluid my-4">
                    <div class="row">
                        <div class="col-md-5 col-12">
                            <div class="completed-course  overflow-hidden d-flex align-items-end font-white"
