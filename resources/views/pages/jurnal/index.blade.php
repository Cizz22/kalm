...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6 col-12 px-4 py-3 vh-100 m-0 left">
                <div>
                    <h1>{{ Auth::user()->name }}'s Journal</h1>
                </div>
                <div>
                    <h4>Notebooks</h4>
                    <div class="d-flex flex-md-row flex-column justify-content-start gap-5">
                        <div>
            ...
            <div class="col-md-6 col-12 right m-0 p-0">
